...
var _imubJs = require("./core/imub.js");
...
class App extends (0, _imubJs.Component) {
    render() {
...
},{"./core/imub.js":"KJJwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/TheHeader.js":"3Cyq4","./components/TheFooter.js":"b3x3c"}],"KJJwm":[function(require,module,exports) {
// Component
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imub = require("../core/imub");
class TheHeader extends (0, _imub.Component) {
    constructor(){
        super({
            tagName: "header",
            state: {
...
},{"../core/imub":"KJJwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b3x3c":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imub = require("../core/imub");
var _about = require("../store/about");
var _aboutDefault = parcelHelpers.interopDefault(_about);
class TheFooter extends (0, _imub.Component) {
    constructor(){
        super({
            tagName: "footer"
        });
    ...
    render() {
        const { blog, repo } = (0, _aboutDefault.default).state;
        this.el.innerHTML = /* html */ `
      <div>
        <a href="${blog}">
          Github Repository
...
},{"../core/imub":"KJJwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../store/about":"4RAJO"}],"4RAJO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imub = require("../core/imub");
exports.default = new (0, _imub.Store)({
    ...
    repo: "https://github.com/imub"
});

},{"../core/imub":"KJJwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3L9mC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imubJs = require("../core/imub.js");
...
exports.default = (0, _imubJs.createRouter)([
    {
        path: "#/",
...
},{"../core/imub.js":"KJJwm","./Home":"0JSNG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Movie":"1LTyN","./About":"gdB30","./NotFound":"4fDiL"}],"0JSNG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imubJs = require("../core/imub.js");
...
class Home extends (0, _imubJs.Component) {
    render() {
...
},{"../core/imub.js":"KJJwm","../components/Headline.js":"gaVgo","../components/Search.js":"jqPPz","../components/MovieList.js":"8UDl3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../components/MovieListMore.js":"3ZUar"}],"gaVgo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imubJs = require("../core/imub.js");
class Headline extends (0, _imubJs.Component) {
    render() {
...
},{"../core/imub.js":"KJJwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jqPPz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imubJs = require("../core/imub.js");
var _movieJs = require("../store/movie.js");
var _movieJsDefault = parcelHelpers.interopDefault(_movieJs);
class Search extends (0, _imubJs.Component) {
    render() {
...
},{"../core/imub.js":"KJJwm","../store/movie.js":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kq1bo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "searchMovies", ()=>searchMovies);
parcelHelpers.export(exports, "getMovieDetails", ()=>getMovieDetails);
var _imubJs = require("../core/imub.js");
const store = new (0, _imubJs.Store)({
    searchText: "",
    page: 1,
    pageMax: 1,
    movies: [],
...
const searchMovies = async (page)=>{
    ...
    try {
        const res = await fetch(`https://www.omdbapi.com/?i=tt3896198&apikey=91d05104&s=${store.state.searchText}&page=${page}`);
...
const getMovieDetails = async (id)=>{
    try {
        const res = await fetch(`https://omdbapi.com?apikey=91d05104&i=${id}&plot=full`);
...
},{"../core/imub.js":"KJJwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8UDl3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imubJs = require("../core/imub.js");
var _movieJs = require("../store/movie.js");
...
class MovieList extends (0, _imubJs.Component) {
    constructor(){
        super();
...
},{"../core/imub.js":"KJJwm","../store/movie.js":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./MovieItem.js":"fAzE8"}],"fAzE8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imub = require("../core/imub");
class MovieItem extends (0, _imub.Component) {
    constructor(props){
        super({
            props,
            tagName: "a"
...
},{"../core/imub":"KJJwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3ZUar":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imub = require("../core/imub");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class MovieListMore extends (0, _imub.Component) {
    constructor(){
        super({
            tagName: "button"
        });
...
},{"../core/imub":"KJJwm","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1LTyN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imub = require("../core/imub");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class Movie extends (0, _imub.Component) {
    async render() {
...
},{"../core/imub":"KJJwm","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gdB30":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imub = require("../core/imub");
var _about = require("../store/about");
var _aboutDefault = parcelHelpers.interopDefault(_about);
class About extends (0, _imub.Component) {
    render() {
...
},{"../core/imub":"KJJwm","../store/about":"4RAJO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4fDiL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _imub = require("../core/imub");
class NotFound extends (0, _imub.Component) {
    render() {
...
},{"../core/imub":"KJJwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["anvqh","gLLPy"], "gLLPy", "parcelRequire6588")
